...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Очистка и защита от SQL-инъекций
    $username = $conn->real_escape_string($username);

    // Запрос к базе данных для получения хешированного пароля
    ...
    if ($result->num_rows > 0) {
        ...
        // Проверка введенного пароля по отношению к хешированному паролю
        if (password_verify($password, $hashedPassword)) {
            // Пароль верный, перенаправление на основную страницу
